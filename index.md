...
To date, many ad hoc analysis packages have been developed to target selected aspects of ESM simulations.  With the growing scope of CMIP and expectations for efficient “quick look” results, there is a clear need for the community of CMIP analysts to work together.  CMEC advances approaches for the developers of these capabilities to collaborate and to deliver a unified set of results in unison.   
